                    ...
                    <div class="product__media--right__horizontal ">
                        <div class="product__media--preview__horizontal  swiper">
                            <div class="swiper-wrapper">
                                <div v-for="img in product.images" :key="img.id" class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product1.webp"><img class="product__media--preview__items--img" :src="'/storage/'+img.img_url" alt="product-media-img"></a>
                        ...
                        <div class="swiper-wrapper">
                            <div v-for="img in product.images" :key="img.id" class="swiper-slide">
                                <div class="product__media--nav__items">
                                    <img style="object-fit: cover; height: 120px;" class="product__media--nav__items--img" :src="'/storage/'+img.img_url" alt="product-nav-img">
                                </div>
                            </div>
                ...
                <div class="product__details--info">
                    <form action="#">
                        ...
                        <div class="product__details--info__price mb-10">
                            ...
                            <span class="old__price">₦{{product.price}}.00</span>
                        </div>
...
export default {
    ...
    methods: {
        getProductDetails(){
            ...
            axios({
                    url: `/api/v1/products/${this.product_code}`,
                    method: 'get',
                    headers: {
