                ...
                <div class="row">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <div class="product__sidebar">
                                    ...
                                    <div class="small__product d-flex align-items-center mb-20">
                                        ...
                                        <div class="small__product--content">
                                            <h3 class="small__product--title h4"><a href="product-details.html">Advanced To Watch ww  </a></h3>
                                            <div class="small__product--price">
                    ...
                    <div class="col-xl-9 col-lg-8">
                        ...
                        <div class="shop__product--wrapper">
                            <a class="product__card--action__btn" title="Quick View" data-open="modal1" href="javascript:void(0)">JKJHKHKH
