                        ...
                        <div class="shop__sidebar--widget widget__area d-md-none">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__categories--menu">
                                    <li v-for="category in categories" :key="category.id" class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="assets/img/product/small-product1.webp" alt="categories-img">
                                            <span class="widget__categories--menu__text">{{category.categoryName}}</span>
                                            <svg v-if="category.subcategories" class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg>
                                        </label>

                                        <div v-if="category.subcategories" class="c">
                                                 <ul v-if="category.subcategories.length !=0" class="widget__categories--sub__menu">
                                            <li v-for="subCat in category.subcategories" :key="subCat.id" class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.html">
                                                    ...
                                                    <span class="widget__categories--sub__menu--text">{{ subCat.categoryName }}</span>
                                                </a>
                                            </li>
                                ...
                                <div class="product__sidebar">
                                    <div class="small__product d-flex align-items-center mb-20">
                                        <div class="small__product--thumbnail position__relative">
                                            <a class="small__product--link display-block" :href="'/product-details/'">
                                        ...
                                        <div class="small__product--content">
                                            <h3 class="small__product--title h4"><a :href="'/product-details/'">Advanced Analytic </a></h3>
                                    ...
                                    <div class="small__product d-flex align-items-center mb-20">
                                        ...
                                        <div class="small__product--content">
                                            <h3 class="small__product--title h4"><a :href="'/product-details/'">Advanced To Watch ww  </a></h3>
                                            <div class="small__product--price">
                                    ...
                                    <div class="small__product d-flex align-items-center">
                                        ...
                                        <div class="small__product--content">
                                            <h3 class="small__product--title h4"><a :href="'/product-details/'">Lorem ipsum dolor. </a></h3>
                                            <div class="small__product--price">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__tagcloud">
                                    <li v-for="brand in brands" :key="brand.id" class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="">{{brand.categoryName}}</a></li>
                                ...
                                <div id="product_grid" class="tab_pane active show">
                                    <div class="product__section--inner product__grid--inner">
                                        <div class="row row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-2 mb--n30">
                                            ...
                                            <div v-for="product in products" :key="product.id" class="col custom-col-2 mb-30">

                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" :href="'/product-details/'+product.id">
                                                        ...
                                                        <ul class="product__card--action d-flex align-items-center justify-content-center">
                                                            ...
                                                            <li class="product__card--action__list">
                                                                <a
                                                                onclick="document.getElementById('modal_launcher').click()"
                                                                id="modal_launcher"
                                                                class="product__card--action__btn" title="Quick View" data-open="modal1" href="javascript:void(0)">
                                                    ...
                                                    <div class="product__card--content text-center">
                                                        ...
                                                        <h3 class="product__card--title"><a :href="'/product-details/'+product.id">{{product.name}} </a></h3>
